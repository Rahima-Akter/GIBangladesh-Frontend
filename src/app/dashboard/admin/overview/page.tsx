        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            <Card className="bg-primary text-on-primary border-none">
              ...
              <h4 className="text-lg font-bold mb-2 text-on-primary">
                Market Demand Alert
              </h4>
              <p className="text-white/80 text-body-sm mb-6 leading-relaxed">
                Demand for "Shetal Pati" in European markets has increased by
                18% this quarter. AI suggests optimizing your catalog for
                international shipping.
              </p>
              <Button
                variant="secondary"
                className="w-full bg-white text-primary border-none hover:bg-white/90"
              >
                Generate Strategy
              </Button>
            </Card>
            ...
            <Card className="p-6">
              <h4 className="text-label-md font-bold uppercase tracking-widest text-on-surface-variant mb-4">
                Upcoming Tasks
              </h4>
              <div className="space-y-4">
                {[
                  {
                    task: "Renew GI Tag License",
                    due: "In 3 days",
                    priority: "High",
                  },
                  {
                    task: "Update Pricing for Jamdani",
                    due: "Next week",
                    priority: "Low",
                  },
                ].map((item, i) => (
