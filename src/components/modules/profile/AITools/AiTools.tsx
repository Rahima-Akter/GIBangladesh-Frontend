                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-lg">
                    ...
                    <div className="bg-surface-container-lowest dark:bg-inverse-surface border border-outline-variant dark:border-on-surface-variant rounded-xl p-lg flex flex-col h-[480px]">
                        <div className="flex items-center gap-md mb-md">
                            <div className="w-10 h-10 bg-primary-container/10 dark:bg-primary/20 rounded-lg flex items-center justify-center">
                                <span className="material-symbols-outlined text-primary dark:text-inverse-primary">edit_note</span>
                            </div>
                        ...
                        <div className="space-y-md grow">
                            <div>
                                ...
                                <input className="w-full bg-surface dark:bg-on-surface-variant border-outline-variant dark:border-outline rounded-lg px-md py-sm text-body-sm focus:ring-primary focus:border-primary dark:text-inverse-on-surface" placeholder="Enter content topic..." type="text" />
                            </div>
                            <div>
                                ...
                                <select className="w-full bg-surface dark:bg-on-surface-variant border-outline-variant dark:border-outline rounded-lg px-md py-sm text-body-sm focus:ring-primary focus:border-primary dark:text-inverse-on-surface">
                                    <option>Formal</option>
                                    <option>Short &amp; Punchy</option>
                                    <option>Detailed Analysis</option>
                                </select>
                            </div>
                            <button className="w-full bg-primary text-on-primary dark:bg-inverse-primary dark:text-primary font-bold py-sm rounded-lg flex items-center justify-center gap-sm hover:opacity-90 transition-opacity">
                                <span className="material-symbols-outlined text-[18px]">auto_awesome</span>
                                Generate
                            </button>
                            <div className="relative bg-surface-container dark:bg-on-surface-variant/50 rounded-lg p-md h-32 overflow-y-auto border border-dashed border-outline">
                                <p className="text-body-sm text-on-surface-variant dark:text-outline-variant">Generated content will appear here...</p>
                                <button className="absolute top-2 right-2 p-xs bg-white dark:bg-on-surface-variant rounded shadow-sm hover:bg-surface-container-high transition-colors">
                                    <span className="material-symbols-outlined text-[18px] text-primary dark:text-inverse-primary">content_copy</span>
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-surface-container-lowest dark:bg-inverse-surface border border-outline-variant dark:border-on-surface-variant rounded-xl p-lg flex flex-col h-[480px]">
                        <div className="flex items-center gap-md mb-md">
                            ...
                            <h3 className="font-h3 text-h3 text-on-surface dark:text-inverse-on-surface text-body-lg">AI Text Rewriter</h3>
                        </div>
                        <div className="space-y-md flex-grow">
                            <div>
                                ...
                                <textarea className="w-full bg-surface dark:bg-on-surface-variant border-outline-variant dark:border-outline rounded-lg px-md py-sm text-body-sm h-24 focus:ring-secondary focus:border-secondary dark:text-inverse-on-surface resize-none" placeholder="Paste your text here..."></textarea>
                            </div>
                            <div className="flex gap-md">
                                <div className="flex-grow">
                                    <select className="w-full bg-surface dark:bg-on-surface-variant border-outline-variant dark:border-outline rounded-lg px-md py-sm text-body-sm focus:ring-secondary focus:border-secondary dark:text-inverse-on-surface">
                                ...
                                <button className="bg-secondary text-on-secondary dark:bg-secondary-fixed dark:text-on-secondary-fixed font-bold px-lg py-sm rounded-lg hover:opacity-90 transition-opacity">
                                    Rewrite
                                </button>
                            </div>
                            <div className="relative bg-surface-container dark:bg-on-surface-variant/50 rounded-lg p-md h-32 overflow-y-auto border border-dashed border-outline">
                                ...
                                <button className="absolute top-2 right-2 p-xs bg-white dark:bg-on-surface-variant rounded shadow-sm">
                    ...
                    <div className="bg-surface-container-lowest dark:bg-inverse-surface border border-outline-variant dark:border-on-surface-variant rounded-xl p-lg flex flex-col h-[480px]">
                        <div className="flex items-center gap-md mb-md">
                            <div className="w-10 h-10 bg-primary-container/10 dark:bg-primary/20 rounded-lg flex items-center justify-center">
                                <span className="material-symbols-outlined text-primary dark:text-inverse-primary">forum</span>
                            </div>
                            <h3 className="font-h3 text-h3 text-on-surface dark:text-inverse-on-surface text-body-lg">AI Chat Assistant</h3>
                        </div>
                        <div className="flex-grow flex flex-col overflow-hidden">
                            <div className="flex-grow chat-scroll overflow-y-auto space-y-md mb-md px-xs">
                                <div className="flex gap-sm">
                                    ...
                                    <div className="bg-surface-container dark:bg-on-surface-variant px-md py-sm rounded-xl rounded-tl-none">
                                ...
                                <div className="flex gap-sm justify-end">
                                    <div className="bg-primary text-on-primary dark:bg-primary-container dark:text-on-primary-container px-md py-sm rounded-xl rounded-tr-none">
                            ...
                            <div className="mt-auto">
                                <div className="relative">
                                    <input className="w-full bg-surface dark:bg-on-surface-variant border-outline-variant dark:border-outline rounded-full pl-md pr-[50px] py-sm text-body-sm focus:ring-primary focus:border-primary dark:text-inverse-on-surface" placeholder="Type message..." type="text" />
                                    <button className="absolute right-1 top-1 bottom-1 aspect-square bg-primary text-on-primary rounded-full flex items-center justify-center hover:opacity-90">
