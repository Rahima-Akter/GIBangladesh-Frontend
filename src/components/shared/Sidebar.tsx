...
const adminMenuItems = [
  { icon: IconLayoutDashboard, label: "Overview", href: "/dashboard/admin/overview" },
  {
    icon: IconUsers,
  ...
  },
  {
    ...
    href: "/dashboard/admin/product-moderation",
  },
  {
    icon: IconPencilStar,
    label: "Blog Review",
  ...
  },
  {
    ...
    href: "/dashboard/admin/comment-moderation",
  },
  { icon: IconRobot, label: "Ai Logs", href: "/dashboard/admin/ai-logs" },
  {
      ...
      >
        <div className="flex h-16 items-center justify-between border-b border-outline-variant dark:border-gray-800 px-6">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="font-semibold text-lg dark:text-inverse-on-surface">
              GIBangladesh
            </span>
          </Link>
          <button
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-1">
          <p className="px-2 pb-2 text-[10px] font-bold uppercase tracking-widest text-on-surface-variant/60 dark:text-gray-300">
            Main Menu
          </p>
          {(role === "ADMIN" ? adminMenuItems : menuItems).map((item) => {
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  isActive
                    ? "bg-primary/10 text-primary dark:bg-primary-fixed-dim/10 dark:text-primary-fixed-dim"
                  ...
                  <item.icon
                    className={cn(
                      ...
                      isActive
                        ...
                        : "text-on-surface-variant/70 dark:text-outline-variant/70",
                    )}
                  />
                  {item.label}
                </div>
          ...
          <div className="rounded-xl bg-surface-container-high dark:bg-on-surface-variant/10 p-4">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 overflow-hidden">
                <p className="text-label-md font-bold truncate dark:text-inverse-on-surface">
                  Jamdani S.
                </p>
                <p className="text-[10px] text-on-surface-variant dark:text-outline-variant truncate">
                  jamdani@gi.com.bd
                </p>
              </div>
            </div>
